...
const animateElements = document.querySelectorAll(
  ".horario-card, .expositor-card, .patrocinador-card, .programacao-item, .stat-card",
);
...
class Carousel {
  constructor(carouselName, desktopCardsPerView = 3) {
    ...
    this.container = document.querySelector(
      `.carousel-container[data-carousel="${carouselName}"]`,
    );
    this.track = this.container?.querySelector(".carousel-track");
    this.prevBtn = document.querySelector(
      `.carousel-btn-prev[data-carousel="${carouselName}"]`,
    );
    this.nextBtn = document.querySelector(
      `.carousel-btn-next[data-carousel="${carouselName}"]`,
    );
    this.dotsContainer = document.querySelector(
      `.carousel-dots[data-carousel="${carouselName}"]`,
    );
...
function initCountdown() {
  ...
  if (eventDateElement) {
    eventDateElement.textContent = eventDate.toLocaleDateString(
      "pt-BR",
      options,
    );
  }
